...
/*
 * @Author: Jandan
 * @Date: 2021-02-13 23:56:48
 * @LastEditTime: 2021-02-14 00:41:24
 * @Description: 文章表
 */
...
class Article extends Migrator
{
  ...
  {
    $table = $this->table('article', ['engine' => 'InnoDB', 'comment' => '文章表']);
    $table->addColumn(Column::char('title')->setOptions(['comment' => '标题']))
      ...
      ->addColumn(Column::tinyInteger('is_top')->setOptions(['default' => 0, 'comment' => '是否推荐']))
      ->addColumn(Column::tinyInteger('is_hot')->setOptions(['default' => 0, 'comment' => '是否热门']))
